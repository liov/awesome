...
# 使用HoughCircles检测圆形
circles = cv2.HoughCircles(edges, cv2.HOUGH_GRADIENT, dp=1.2, minDist=200, param1=200, param2=80, minRadius=50, maxRadius=300)
...
if circles is not None:
    ...
    for (x, y, r) in circles:
        ...
        if (x - r) > 0 and (x + r) < width and (y - r) > 0 and (y + r) < height:
            ...
            # 保留边缘和外部对比度高的圆
            if abs(mean_edge - mean_outside) > 30:  # 根据需要调整此阈值
                # 绘制外圆
